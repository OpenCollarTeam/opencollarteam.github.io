...
- **Bell.**  If your collar has a bell, name the bell prim `Bell` and put in the description field: `Bell~nohide`. Requires [oc_bell](https://github.com/OpenCollarTeam/OpenCollar/blob/master/src/Apps/oc_bell).
