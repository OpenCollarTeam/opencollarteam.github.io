...
- **Bell.**  If your collar has a bell, name the bell prim Bell and put in the description field: `Bell~notexture~nocolor~nohide~noshiny~noglow`. Recquires [oc_bell](https://github.com/OpenCollarTeam/OpenCollar/blob/master/src/collar/oc_bell.lsl).
