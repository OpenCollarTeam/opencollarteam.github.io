...
will "dump" the collar face parameters list into the Local Chat window. 
   ...
   * The entire group of lines after this describe each face of the prim and say what texture to apply there.  !0 is face #0, !1 is face #1, etc.

2. Copy and paste this dump to a text editor.  Copy the parameters you want to use from the chat log (dump) in the text editor to a notecard.
...
4. Reduce this file to the barest essentials. You can do this either in your text editor or in the ntecard itself.  When applying a theme to your collar, the oc_themes script will read each line of the .themes notecard one at a time, applying that parameter 
